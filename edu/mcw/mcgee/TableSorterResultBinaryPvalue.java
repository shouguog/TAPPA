...
public class TableSorterResultBinaryPvalue extends JPanel {
    ...
    public TableSorterResultBinaryPvalue(Hashtable hashExpression){
		hashExpression_normal = hashExpression;
    }

    public TableSorterResultBinaryPvalue(Vector vt_test, int columnNum, String[] columnName, Hashtable hashExpression) {
