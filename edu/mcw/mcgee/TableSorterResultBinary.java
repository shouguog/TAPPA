...
public class TableSorterResultBinary extends JPanel {
    ...
    public TableSorterResultBinary(Hashtable hashExpression){
		hashExpression_normal = hashExpression;
    }

    public TableSorterResultBinary(Vector vt_test, int columnNum, String[] columnName, Hashtable hashExpression) {
        ...
        buttonGet.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent e) {
              ...
              if(selectedRow.length>0){
            	  ...
            	  Hashtable temp = Analyzer.analysis_perm_binary(hashExpression_normal, permNum, vtName, s, hashValue);
          		  //header            	  
            	  ...
            	  System.out.println("I am here" + analysisResult);
                  TableSorterResultBinaryPvalue expTable = new TableSorterResultBinaryPvalue(hashExpression_normal);
    ...
    public void createAndShowGUI(Vector vt_test, int columnNum, String[] columnName) {
      ...
      TableSorterResultBinary newContentPane = new TableSorterResultBinary(vt_test, columnNum, columnName, this.hashExpression_normal);
    ...
    public static void main(String[] args) {
        ...
        //
        TableSorterResultBinary expTable = new TableSorterResultBinary(new Hashtable(1));
